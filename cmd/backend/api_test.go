...
var v2Routes = []struct{ method, path string }{
	...
	{"GET", "/api/v1/private/stocks/fundamental/{ticker}/income-statement"},
	{"GET", "/api/v1/private/stocks/fundamental/{ticker}/balance-sheet"},
	{"GET", "/api/v1/private/stocks/fundamental/{ticker}/cash-flow"},
